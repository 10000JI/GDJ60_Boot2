...
//		
		response.sendRedirect("https://kauth.kakao.com/oauth/logout?client_id="+restKey+"&logout_redirect_uri=http://ec2-13-125-165-249.ap-northeast-2.compute.amazonaws.com/member/socialLogout");
	}
}
